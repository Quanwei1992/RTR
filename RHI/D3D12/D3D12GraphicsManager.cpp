...
HRESULT RTR::D3D12GraphicsManager::CreateRenderTarget() 
{
    HRESULT hr;
...
HRESULT RTR::D3D12GraphicsManager::CreateGraphicsResources()
{
    HRESULT hr;
...
int  RTR::D3D12GraphicsManager::Initialize()
{
    int result = 0;
...
void RTR::D3D12GraphicsManager::Tick()
{
}

void RTR::D3D12GraphicsManager::Finalize()
{
