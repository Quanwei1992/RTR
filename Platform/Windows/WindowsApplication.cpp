...
int RTR::WindowsApplication::Initialize()
{
    int result;
...
void RTR::WindowsApplication::Tick()
{
...
HWND RTR::WindowsApplication::GetMainWindow()
{
    return m_hWnd;
}

void RTR::WindowsApplication::Finalize()
{
}
